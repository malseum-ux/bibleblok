    ...
    if (!access.ok) {
      return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)' }}>
          <div style={{ width: 340, padding: '40px 36px', background: 'var(--bg-sidebar)', border: '1px solid var(--border)', borderRadius: 12, textAlign: 'center' }}>
            ...
            <button onClick={() => supabase.auth.signOut()} style={{ padding: '9px 20px', background: 'var(--bg)', color: 'var(--text)', border: '1px solid var(--border)', borderRadius: 7, fontSize: 13, cursor: 'pointer' }}>
              로그아웃
            </button>
          </div>
        </div>
